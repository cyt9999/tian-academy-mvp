...
const OptionsLab: React.FC = () => {
  ...
  const handleStrategyChange = (id: StrategyType) => {
    ...
    else if (id === 'leaps') { setStrike(Math.round(price * 0.8)); setPremium(Math.round(price * 0.25 * 10) / 10); }
    else if (id === 'strangle') { setStrike(Math.round(price * 0.95)); setPremium(Math.round(price * 0.03 * 10) / 10); }
